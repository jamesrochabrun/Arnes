...
Sources/ArnesKit/
  ...
  MCPHTTP.swift            # streamable-HTTP MCP transport: POST per JSON-RPC message (Accept json+SSE, configured headers, Mcp-Session-Id), SSE or JSON reply, DELETE on stop; injectable MCPHTTPPerformer
